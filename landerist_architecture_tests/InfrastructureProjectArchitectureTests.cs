...
public sealed class InfrastructureProjectArchitectureTests
{
    ...
    public void InfrastructureProject_UsesOnlyDeclaredAdapterDependencies()
    {
        ...
        Assert.Equal(
            ["AWSSDK.CloudFront", "AWSSDK.S3", "Com.Bekijkhet.RobotsTxt", "CsvHelper", "HtmlAgilityPack", "Google.Cloud.AIPlatform.V1", "Google.Cloud.Storage.V1", "Louw.SitemapParser", "Microsoft.Data.SqlClient",
