...
{
    public class BaseDeDatosEmpresasInsertWebsites(IWebsiteAdministrationService websites, IWebsiteNetworkService network) : WebsitesInserter(true, websites, network)
    {
        public void Start()
        {
