...
namespace landerist_library.Parse.ListingParser.StructuredOutputs
{
    ...
    {
        [JsonProperty(StructuredOutputEsParse.FunctionNameIsListing)]
        [System.ComponentModel.Description(StructuredOutputEsParse.FunctionNameIsListingDescription)]
        public bool EsUnAnuncio { get; private set; }


        [JsonProperty(StructuredOutputEsParse.FunctionNameListing, Required = Required.AllowNull)]
        [System.ComponentModel.Description(StructuredOutputEsParse.FunctionNameListingDescription)]

        public StructuredOutputEsListing? Anuncio { get; private set; }


        public (PageType pageType, Listing? listing) ParseListing(Page page)
        {
