...
namespace landerist_library.Parse.Listing.ChatGPT
{
    public class ChatGPTRequest
    {
        ...
        private static readonly List<Tool> Tools = ChatGPTTools.GetTools();
        ...
        public static Tool? GetTool(ChatResponse chatResponse)
        {
            try
            {
        ...
        public static (PageType pageType, landerist_orels.ES.Listing? listing) ParseListing(Page page, Tool tool)
        {
            ...
            try
            {
                ...
                var parseListingResponse = JsonSerializer.Deserialize<ParseListingFunction>(arguments);
