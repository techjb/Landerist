...
namespace landerist_library.Configuration
{
    public class Config
    {
        ...
        public static readonly string VERSION = "3.56";
        ...
        public static readonly int MAX_PAGES_PER_HOSTS_PER_SCRAPE = 2;

        public static readonly int MAX_PAGES_PER_IP_PER_SCRAPE = 2;
