...
namespace landerist_tests
{
    partial class Program
    {
        ...
        private static void Run()
        {
            ...
            var localAIResponse = new landerist_library.Parse.ListingParser.LocalAI.LocalAIRequest().GetResponse(text).Result;
            Console.WriteLine(localAIResponse.GetResponseText());
