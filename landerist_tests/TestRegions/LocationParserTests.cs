...
namespace landerist_tests
{
    internal static class LocationParserTests
    {
        ...
        {
            //var tuple1 = new landerist_library.Parse.Location.Providers.GoogleMaps.GoogleMapsApi().GetLatLng("Av. Domingo Bueno, 126. O Porri̱o, 36.400 Pontevedra", CountryCode.ES);
