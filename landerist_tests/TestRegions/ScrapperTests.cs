...
namespace landerist_tests
{
    internal static class ScrapperTests
    {
        public static void Run()
        {
            ...
            //new landerist_library.Scrape.Scraper().Scrape("https://www.remax.es/buscador-de-inmuebles/venta/chalet-individual/madrid/rivas-vaciamadrid/central/1866819/", false);
